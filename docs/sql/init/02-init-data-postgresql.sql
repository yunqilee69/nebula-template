...
ON CONFLICT (id) DO UPDATE SET
    ...
    active_menu_path = EXCLUDED.active_menu_path,
...
INSERT INTO auth_button (
    ...
    ('0196dbe0a6f17000a000000000000201', '0196dbe0a6f17000a000000000000004', 'AUTH_USER_CREATE', '新增用户', 'add', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000202', '0196dbe0a6f17000a000000000000004', 'AUTH_USER_EDIT', '编辑用户', 'edit', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000203', '0196dbe0a6f17000a000000000000004', 'AUTH_USER_ASSIGN', '分配用户角色组织', 'assign', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000204', '0196dbe0a6f17000a000000000000004', 'AUTH_USER_RESET_PASSWORD', '重置用户密码', 'reset-password', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000205', '0196dbe0a6f17000a000000000000004', 'AUTH_USER_CHANGE_PASSWORD', '修改用户密码', 'change-password', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000206', '0196dbe0a6f17000a000000000000004', 'AUTH_USER_DELETE', '删除用户', 'delete', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000207', '0196dbe0a6f17000a000000000000006', 'AUTH_ROLE_CREATE', '新增角色', 'add', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000208', '0196dbe0a6f17000a000000000000006', 'AUTH_ROLE_EDIT', '编辑角色', 'edit', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000209', '0196dbe0a6f17000a000000000000006', 'AUTH_ROLE_DELETE', '删除角色', 'delete', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000210', '0196dbe0a6f17000a000000000000005', 'AUTH_ORG_CREATE', '新增组织', 'add', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000211', '0196dbe0a6f17000a000000000000005', 'AUTH_ORG_EDIT', '编辑组织', 'edit', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000212', '0196dbe0a6f17000a000000000000005', 'AUTH_ORG_DELETE', '删除组织', 'delete', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000213', '0196dbe0a6f17000a000000000000007', 'AUTH_MENU_CREATE', '新增菜单', 'add', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000214', '0196dbe0a6f17000a000000000000007', 'AUTH_MENU_EDIT', '编辑菜单', 'edit', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('0196dbe0a6f17000a000000000000215', '0196dbe0a6f17000a000000000000007', 'AUTH_MENU_DELETE', '删除菜单', 'delete', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    ('0196dbe0a6f17000a000000000000222', '0196dbe0a6f17000a000000000000010', 'AUTH_DATA_SCOPE_CREATE', '新增数据范围', 'add', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
INSERT INTO sys_dict_type (
    ...
    ('019cf114a00070008000000000000001', 'param_module', '参数模块', '系统参数所属模块分类，用于按模块分组展示参数', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000002', 'common_enable_status', '启用状态', '通用启用/禁用状态，字典项值使用0/1编码', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000005', 'NOTIFY_CHANNEL_TYPE', '通知渠道', '通知发送支持的渠道类型', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (code) DO UPDATE SET
    name = EXCLUDED.name,
    remark = EXCLUDED.remark,
    update_time = EXCLUDED.update_time;
...
INSERT INTO sys_dict_item (
    ...
    ('019cf114a00070008000000000000011', 'param_module', '认证模块', 'auth', 1, TRUE, NULL, '认证授权相关参数', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000012', 'param_module', '字典模块', 'dict', 2, TRUE, NULL, '数据字典相关参数', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000013', 'param_module', '参数模块', 'param', 3, TRUE, NULL, '系统参数中心相关参数', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000014', 'param_module', '通知模块', 'notify', 4, TRUE, NULL, '公告通知相关参数', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000016', 'param_module', '存储模块', 'storage', 6, TRUE, NULL, '文件存储相关参数', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000017', 'param_module', '调度模块', 'scheduler', 7, TRUE, NULL, '任务调度相关参数', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000018', 'param_module', '前端配置模块', 'frontend', 8, TRUE, NULL, '前端初始化、主题、语言和布局相关参数', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000019', 'param_module', '审计模块', 'audit', 9, TRUE, NULL, '审计日志相关参数', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000021', 'common_enable_status', '禁用', '0', 1, TRUE, NULL, '禁用状态', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000022', 'common_enable_status', '启用', '1', 2, TRUE, NULL, '启用状态', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000041', 'NOTIFY_CHANNEL_TYPE', '站内信', 'SITE', 1, TRUE, NULL, '站内消息通知渠道', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000042', 'NOTIFY_CHANNEL_TYPE', '邮件', 'EMAIL', 2, TRUE, NULL, '邮件通知渠道', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000043', 'NOTIFY_CHANNEL_TYPE', '企业微信群机器人', 'WECOM_GROUP_WEBHOOK', 3, TRUE, NULL, '企业微信群机器人 Webhook 通知渠道', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000044', 'NOTIFY_CHANNEL_TYPE', '飞书群机器人', 'FEISHU_GROUP_WEBHOOK', 4, TRUE, NULL, '飞书群机器人 Webhook 通知渠道', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00070008000000000000045', 'NOTIFY_CHANNEL_TYPE', '钉钉群机器人', 'DINGTALK_GROUP_WEBHOOK', 5, TRUE, NULL, '钉钉群机器人 Webhook 通知渠道', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO sys_notify_template_field (
    ...
    ('019cf114a00090008000000000000004', '019cf114a00090008000000000000001', 'userId', '接收用户ID', TRUE, NULL, 'user-1', '被重置密码的用户ID', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00090008000000000000005', '019cf114a00090008000000000000001', 'username', '登录账号', TRUE, NULL, 'alice', '被重置密码的登录账号', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00090008000000000000006', '019cf114a00090008000000000000001', 'nickname', '用户昵称', FALSE, '', 'Alice', '被重置密码的用户昵称', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('019cf114a00090008000000000000007', '019cf114a00090008000000000000001', 'defaultPassword', '重置后密码', TRUE, NULL, '12345678', '管理员重置后的默认密码', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (template_id, field_code) DO UPDATE SET
...
ON CONFLICT (template_id, channel_type) DO UPDATE SET
...
INSERT INTO sys_param (
    ...
    ('01959f0aa4d37c0d91a7d9af9c7d1001', 'login.username.allow-register', '用户名注册开关', '用户名密码登录固定开启，仅注册开关允许运行时调整', 'true', 'BOOLEAN', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1002', 'login.username.password-min-length', '用户名密码最小长度', '用户名注册密码最小长度', '8', 'INT', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1003', 'login.username.password-max-length', '用户名密码最大长度', '用户名注册密码最大长度', '20', 'INT', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1024', 'login.username.reset-default-password', '用户名重置默认密码', '管理员重置用户密码时使用的默认密码', '12345678', 'STRING', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1004', 'login.username.login-fail-max-count', '用户名登录失败最大次数', '用户名登录失败最大次数，0表示不开启失败锁定', '5', 'INT', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1005', 'login.username.lock-time-hours', '用户名锁定时长(小时)', '用户名登录锁定时长，按小时配置', '1', 'INT', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1006', 'login.phone.enabled', '手机号登录开关', '手机号登录开关', 'true', 'BOOLEAN', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1007', 'login.phone.allow-register', '手机号注册开关', '手机号注册开关', 'true', 'BOOLEAN', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1008', 'login.phone.code-expire-minutes', '手机号验证码有效期(分钟)', '手机号验证码有效期', '5', 'INT', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1009', 'login.phone.send-interval-seconds', '手机号验证码发送间隔(秒)', '手机号验证码发送间隔', '60', 'INT', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1010', 'login.email.enabled', '邮箱登录开关', '邮箱登录开关', 'true', 'BOOLEAN', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1011', 'login.email.allow-register', '邮箱注册开关', '邮箱注册开关', 'true', 'BOOLEAN', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('01959f0aa4d37c0d91a7d9af9c7d1012', 'login.email.code-expire-minutes', '邮箱验证码有效期(分钟)', '邮箱验证码有效期', '10', 'INT', NULL, 'auth', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
-- 使用 gen_random_uuid() 生成 UUID（PostgreSQL 13+ 内置支持）
...
-- 步骤 3：为 ADMIN 角色生成所有 BUTTON 类型权限
INSERT INTO auth_permission (
    id, subject_type, subject_id, resource_type, resource_id, effect, scope, create_time, update_time
)
SELECT
